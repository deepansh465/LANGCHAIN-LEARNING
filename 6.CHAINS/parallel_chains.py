from langchain_openai import ChatOpenAI                               #well provide system with a note then will parallely get notes and 
from dotenv import load_dotenv                                         #quiz of the prvided docs parellaly then merge and show 
